    ...
    <div className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-sm text-blue-400 mb-8 backdrop-blur-sm"
        >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-zinc-900 to-zinc-600 dark:from-white dark:to-white/50"
        >
          Predict. Prepare. <br />
        ...
        >
          <button className="group relative px-8 py-4 bg-primary text-white rounded-xl font-bold text-lg overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-blue-500/20">
          ...
          <button className="px-8 py-4 glass text-white rounded-xl font-bold text-lg hover:bg-white/10 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-zinc-300">Govt. Data Integration</span>
          </div>
          <div className="flex items-center gap-3">
            <Waves className="w-6 h-6 text-blue-500" />
            <span className="font-semibold text-zinc-300">AI Risk Analysis</span>
          </div>
        </motion.div>
      </div>
    </div>
