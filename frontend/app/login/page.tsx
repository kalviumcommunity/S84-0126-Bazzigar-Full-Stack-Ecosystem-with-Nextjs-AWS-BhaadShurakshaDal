  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white dark:bg-black relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-md p-8 glass rounded-3xl relative z-10 mx-4 bg-white/80 dark:bg-black/50 border border-zinc-200 dark:border-zinc-800"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">
            Sign in to access real-time flood monitoring
          </p>
        </div>
        ...
        <form className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-zinc-200 dark:border-zinc-800 rounded-xl px-10 py-3 outline-none focus:ring-2 focus:ring-blue-500/50 transition-all dark:text-white"
              />
            </div>
          </div>
          ...
          <button className="w-full bg-primary hover:bg-blue-600 text-white py-3 rounded-xl font-bold transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2">
